...
- 🎓 Изучаю Software Engineering.
- 🧠 Проектирую multi-agent среды и создаю локальных ИИ-ассистентов.
- 🔭 **Текущие проекты:**
  - **Lobster (OpenClaw)** — локальный ИИ-ассистент с десктопным оверлеем (PyQt6), развернутый через Docker на Raspberry Pi.
